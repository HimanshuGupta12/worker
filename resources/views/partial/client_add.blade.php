<form class="add_edit_clientform" action="{{ $client_store_url }}" method="post">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div id="client-add-success" class="alert alert-success" style="display: none;"></div>
                            <div id="client-add-fail" class="alert alert-danger" style="display: none;"></div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <div class="form-check mb-3" style="float: left;">
                                    <input class="form-check-input" type="radio" name="type" value="private" checked="true" class="client_type" >
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <div class="form-check" style="float: left;">
                                    <input class="form-check-input" type="radio" value="business" name="type" class="client_type">
                                    <label class="form-check-label">
                                        Business
                                    </label>
                                </div>
...
{{--                                            <option data-countryCode="ZW" value="263" @if (old('phone_country', $client->phone_country) == 263) selected @endif>Zimbabwe (+263)</option>--}}
                        ...
                        <div class="company_data row" style="display: none;">
                        ...
                        <div class="row"> 
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="text" name="street" value="" placeholder="Enter street address">
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="postcode" value="" placeholder="Enter post code">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                              <label class="form-label custom_form_label">Additional notes about the client</label>
                                <textarea class="form-control" name="additional_note" style="height: 100px;" placeholder="Write a note"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <button id='create_client' class="btn btn-primary mt-3">Save</button>
</form>