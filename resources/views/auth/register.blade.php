...
<div class="mt-4">
            ...
            <div class="mb-2 mt-4">
                            <x-label for="phone_no" :value="__('Phone country')" />
                                <div class="row">
                                    <div class="col-5">
                                        <select class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" name="phone_country" id="phone_country">
...
{{--                                            <option data-countryCode="ZW" value="263" @if (old('phone_country', $worker->phone_country) == 263) selected @endif>Zimbabwe (+263)</option>--}}
                                    ...
                                    <!--<div class="col-7">-->
                                    <!--    <input class="block mt-1 w-full" type="text" name="phone_no" value="{{ old('phone_no', $worker->phone_no) }}" placeholder="66123456">-->
                                    <!--</div>-->
                                </div>
                            </div>
            ...
            <div class="mt-4">
                ...
                <input class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="phone_no" value="{{ old('phone_no', $worker->phone_no) }}">
            </div>
            <!-- <div class="mt-4">
                <x-label for="phone_no" :value="__('Phone no')" />

                <x-input id="phone_no" class="block mt-1 w-full" type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" name="phone_no" :value="old('phone_no')" required />
            </div> -->
